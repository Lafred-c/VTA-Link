...
function de() {
  ...
  for (var n = e[0], o2 = [], r3 = 1, s2 = e.length; r3 < s2; r3 += 1) o2.push(e[r3]);
...
var fe = (function() {
  ...
  return e.prototype.indexOfGroup = function(e2) {
    ...
    if (e2 >= this.groupSizes.length) {
      for (var n = this.groupSizes, o2 = n.length, r3 = o2; e2 >= r3; ) if ((r3 <<= 1) < 0) throw he(16, "".concat(e2));
    ...
    for (var n = this.groupSizes[e2], o2 = this.indexOfGroup(e2), r3 = o2 + n, s2 = o2; s2 < r3; s2++) t += "".concat(this.tag.getRule(s2)).concat(g);
    return t;
  }, e;
})();
var me = 1 << 30;
...
var Ne = function(e, t, n) {
  for (var o2, r3 = n.split(","), s2 = 0, i2 = r3.length; s2 < i2; s2++) (o2 = r3[s2]) && e.registerName(t, o2);
};
var Pe = function(e, t) {
...
function it(e, r3, s2) {
  ...
  return D2.attrs = S2, D2.componentStyle = N2, D2.displayName = y2, D2.shouldForwardProp = w2, D2.foldedComponentIds = i2 ? ie(a2.foldedComponentIds, a2.styledComponentId) : "", D2.styledComponentId = g2, D2.target = i2 ? a2.target : e, Object.defineProperty(D2, "defaultProps", { get: function() {
    ...
    this._foldedDefaultProps = i2 ? (function(e3) {
      ...
      for (var o2 = 0, r4 = t; o2 < r4.length; o2++) le(e3, r4[o2], true);
      return e3;
...
function ft(n) {
  for (var r3 = [], s2 = 1; s2 < arguments.length; s2++) r3[s2 - 1] = arguments[s2];
  ...
  var l2 = function(e) {
    ...
    return import_react.default.Children.count(e.children) && console.warn("The global style component ".concat(a2, " was given child JSX. createGlobalStyle does not render children.")), i2.some(function(e2) {
      ...
      if (!t.styleSheet.server) return u2(r4, e, t.styleSheet, n2, t.stylis), function() {
...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React2.useContext(et);
...
var ThemeContext = React6.createContext(null);
if (true) {
...
function useLayerOrder(theme) {
  ...
  return (0, import_jsx_runtime6.jsx)(GlobalStyles_default2, {
    styles: layerOrder
  });
}
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React13.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React13.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React13.useMemo(() => storageManager?.({
  ...
  const [isClient, setIsClient] = React13.useState(noSsr || !isMultiSchemes);
  React13.useEffect(() => {
    setIsClient(true);
  }, []);
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React14.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const initialTheme = React14.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React14.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const memoTheme2 = React14.useMemo(() => {
    ...
    const element = (0, import_jsx_runtime9.jsxs)(React14.Fragment, {
...
function GlobalStyles3(props) {
  return (0, import_jsx_runtime13.jsx)(GlobalStyles_default2, {
    ...props,
...
function globalCss(styles) {
  return function GlobalStylesWrapper(props) {
    return (
      ...
      (0, import_jsx_runtime14.jsx)(GlobalStyles_default3, {
...
var SvgIcon = React21.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime16.jsxs)(SvgIconRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
    ...
    ownerState,
    children: [hasSvgAsChild ? children.props.children : children, titleAccess ? (0, import_jsx_runtime16.jsx)("title", {
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime17.jsx)(SvgIcon_default, {
...
//# sourceMappingURL=chunk-6HUAVSYT.js.map
