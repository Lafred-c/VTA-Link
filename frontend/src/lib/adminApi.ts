...
export const adminApi = {
  ...
  updateUser: (id: string, data: { email?: string; password?: string; role?: string; first_name?: string; last_name?: string; contact_number?: string; address?: string; is_active?: boolean; username?: string }) =>
    adminFetch('PUT', `/api/admin/users/${id}`, data),
