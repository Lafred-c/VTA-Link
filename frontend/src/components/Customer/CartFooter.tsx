    ...
    <div className="sticky bottom-0 left-0 right-0 bg-white/80 backdrop-blur-md border-t border-gray-100 px-10 py-6 flex justify-between items-center shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.05)] z-20 -mx-8">
      ...
      <div className="flex items-center gap-12">
        ...
        <button
          onClick={onCheckout}
          disabled={isLoading}
          className="px-16 py-4 bg-cyan-400 hover:bg-cyan-500 text-white font-extrabold rounded-xl shadow-lg shadow-cyan-100 transition-all transform hover:scale-[1.05] active:scale-95 cursor-pointer text-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:active:scale-100">
