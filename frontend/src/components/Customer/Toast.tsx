    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-10 left-1/2 z-[300] flex items-center gap-3 px-6 py-4 bg-gray-900 border border-gray-800 text-white rounded-2xl shadow-2xl min-w-[320px]">
          <div className={isError ? "bg-red-500/10 p-2 rounded-lg" : "bg-green-500/10 p-2 rounded-lg"}>
            {isError ? (
          ...
          {onAction && actionLabel && (
            <button
              ...
              } text-xs font-bold rounded-lg transition-colors border ${
