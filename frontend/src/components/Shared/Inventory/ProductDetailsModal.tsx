...
export const ProductDetailsModal: React.FC<ProductDetailsModalProps> = ({
  ...
  return (
    <div
      ...
      onClick={onClose}>
      <div
        className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-y-auto p-4 sm:p-8 relative"
        ...
        <span
          className={`text-xs font-semibold px-2 py-1 rounded-full ${product.isActive ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-500"}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 mb-6">
          ...
          <div>
            <p className="text-xs text-gray-500">Size / Spec</p>
            <p className="text-sm font-semibold text-gray-900">
              {product.sizeSpec || "—"}
            </p>
          </div>
        ...
        <h4 className="text-sm font-bold text-gray-800 mb-2">
          Bill of Materials ({product.bom.length} items)
        </h4>
        ...
        <div className="mt-6">
          <button
            onClick={onClose}
            className="w-full px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-xl">
            Close
          </button>
        </div>
      </div>
